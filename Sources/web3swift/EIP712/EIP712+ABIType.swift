...
public indirect enum EIP712_ABIType: Equatable, CustomStringConvertible, Hashable {
    ...
    case function(EIP712_Function)
    
    /// Fixed-length array of M elements, `M > 0`, of the given type.
    case array(EIP712_ABIType, Int)
    ...
    case dynamicArray(EIP712_ABIType)
    
    /// Tuple consisting of elements of the given types
    case tuple([EIP712_ABIType])
