...
public final class EIP712_ABIEncoder {
    ...
    /// Encodes an `ABIValue`
    public func encode(_ value: EIP712_ABIValue) throws {
        switch value {
    ...
    /// Encodes a tuple
    public func encode(tuple: [EIP712_ABIValue]) throws {
        var headSize = 0
    ...
    public func encode(function: EIP712_Function, arguments: [Any]) throws {
    ...
    public func encode(_ value: Bool) throws {
        data.append(Data(repeating: 0, count: EIP712_ABIEncoder.encodedIntSize - 1))
    ...
    public func encode(_ value: BigUInt) throws {
        ...
        if valueData.count > EIP712_ABIEncoder.encodedIntSize {
            throw EIP712_ABIError.integerOverflow
        }

        data.append(Data(repeating: 0, count: EIP712_ABIEncoder.encodedIntSize - valueData.count))
    ...
    public func encode(_ value: BigInt) throws {
        guard let serialized = value.serialize(bitWidth: EIP712_ABIEncoder.encodedIntSize) else {
            throw EIP712_ABIError.integerOverflow
        }
    ...
    /// Encodes an address
    public func encodeAddress(_ address: String) throws {
    ...
    public func encode(signature: String) throws {
        data.append(try EIP712_ABIEncoder.encode(signature: signature))
    }
